...
Interested in learning more about why compliance matters and how to achieve it? Start with our [zeroth post](blog/0000_why_compliance.md) and follow along as we go on our compliance journey together.


If you're interested in building out a quality management system ([QMS][qms]) the Neosofia [procedures](qms/procedures/), [policies](qms/policies.md), and [roles](qms/roles.md) can be used as a template for your organization. You can also use concepts like full traceability to apply to an existing [QMS][qms].


Are you an IT system administrator looking to automate your operations? Check out the [operating system scripts](https://github.com/Neosofia/infrastructure) we use to automate our business operations.
