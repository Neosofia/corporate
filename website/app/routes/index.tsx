...
export default function Home() {
  return (
    <>
      <section
        id="home"
        className="min-h-120 md:min-h-200 flex items-center justify-center relative bg-linear-to-br from-slate-900 via-slate-900/95 to-slate-900"
      >
        {/* Content */}
        <div className="text-center z-10 px-4 relative">
          <h1 className="text-4xl md:text-7xl font-bold mb-6 bg-linear-to-r from-red-900 via-red-800 to-red-900 bg-clip-text text-transparent leading-tight">
