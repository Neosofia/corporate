...
2. Advanced features, such as structural validation and separation of concerns, require a SaaS service like [GitHub][gh] or [GitLab][gl]. These services may incur monthly fees if your organization does not already use them or if you prefer not to make your QMS documents public.
