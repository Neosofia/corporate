...
[easx]: /shared/glossary.md#eas-examples
[pol-dip]: /shared/policies.md#data-integrity-and-privacy-dip
[pol]: /shared/policies.md
...
In order to prevent data loss of sensitive information, Neosofia will adopt the following [policies][pol-dip]:
...
I understand that this may be a hard pill for many to swallow (M.A. I'm looking at you and your 25k JIRA messages sent over the last 15 years), but hear me out. When was the last time you actually needed an email more than 90 days old? 180? 365? If that email was deleted, couldn't you ask the sender to resend it? If it's a computer system that sent the email, just log into the system and look at the audit trail! Or perhaps you like to use email as a task or document management system -- might I recommend that you just use a task or document management system, or perhaps finish your to-dos in 90 days :) To be clear -- 90 days is aggressive, most large organizations have 180 or 365-day policies regarding email/chat retention. It's your company at the end of the day, but I strongly recommend putting some type of retention limit plus SSO and MFA policies in place. Or in the words of Elsa (Frozen):
...
We'll be adopting all the policies above into our official [policies][pol] document and breaking them into three levels. The [next post](./0005_beyond_mvc.md) in our series will outline why we're breaking policies up into three levels and expand on our initial set of data integrity policies.
