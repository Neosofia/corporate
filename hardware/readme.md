 ...
 * [Proxmox](proxmox.com) (Debian 12) for the operating system to virtualize all employee workstations plus self-hosted [EASs](qms/glossary.md#enterprise-application-software-eas).
 ...
 * [GitHub](github.com) for [SCC](qms/glossary.md#source-code-control) and [CI/CD](qms/glossary.md#continuous-integration-and-continuous-delivery-cicd)
