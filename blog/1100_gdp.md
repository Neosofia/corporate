---
tags: [qms, documentation, sop]
---

[blog]: blog/0005_beyond_mvc.md
...
[sbar-md]: qms/procedures/IT-245-SystemBackupandRecovery.md
...
[sbar-pdf]: qms/procedures/IT-245-SystemBackupandRecovery.pdf
...
[qa]: qms/glossary.md#quality-assurance-qa
[sme]: qms/glossary.md#subject-matter-expert-sme
[sep]: qms/glossary.md#separation-of-concerns
...
[saas]: qms/glossary.md
[gh]: https://github.com
[gl]: https://about.gitlab.com/
[ux]: qms/glossary.md#user-experience-ux
...
[ts]: public/shared/images/truffle-shuffle.png
...
The current release has two limitations:
1. The user interface for document management is still limited.
2. Advanced features, such as structural validation and separation of concerns, rely on a [SaaS][saas] system like [GitHub][gh] or [GitLab][gl]. These services may incur monthly fees if your organization does not already use them or if you prefer not to make your QMS documents public.

We continue to improve the [UX][ux] around document management and publish guidance for self-hosting Neosofia QMS Docs.

### How Do I Get Started?

Neosofia Docs is available now. You can copy a set of templates, customize them for your organization, and generate a set of version-controlled documents with rich metadata embedded in the final QMS documents. Organizations of any size can benefit from a fully featured set of QMS documents without the cost or overhead of maintaining one.

[sbar-pdf]: qms/procedures/IT-245-SystemBackupandRecovery.pdf
[code]: https://github.com/Neosofia/corporate/tree/mainqms/doc
