...
[lig]:  public/shared/images/let-it-go.png
[ghmfa]: public/shared/images/github-mfa-ss.png
...
We'll be adopting all the policies above into our official [policies][pol] document and breaking them into three levels. The [next post](blog/0005_beyond_mvc.md) in our series will outline why we're breaking policies up into three levels and expand on our initial set of data integrity policies.
